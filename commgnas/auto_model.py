...
class AutoModel(object):
    ...
    def __init__(self, data, search_parameter, gnn_parameter):
        ...
        self.search_algorithm = search_algorithm_getter(self.search_parameter["search_algorithm_type"],  #封装好的搜索算法
                                                        self.data,
    ...
    def search_model(self):
        ...
        self.best_model=self.search_algorithm.search_operator()
    ...
    def derive_target_model(self):
        ...
        gnn_architecture_performance_dict = {}     #把生成的所有架构都作为候选架构
    ...
    def gnn_architecture_performance_load(self, path, data_name):
        ...
        with open(path + data_name + "_new105_reg.txt", "r") as f:    #修改feedback  记得修改读取文件名
